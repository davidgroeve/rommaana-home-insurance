          ...
          <div className="lg:col-span-5 space-y-6">
            {!quoteResult ? (
              <>
                ...
                <div className="grid grid-cols-1 gap-4 animate-fadeIn delay-100">
                  <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">We compare rates to ensure you get the best deal.</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">All policies are fully compliant and regulated.</p>
                    </div>
                  </div>
                </div>
              </>
