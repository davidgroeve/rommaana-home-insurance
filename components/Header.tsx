        ...
        <div className="flex justify-between items-center h-24">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="text-gray-500 hover:text-pomegranate-700 font-bold text-sm px-2"
            >
            ...
            {user ? (
              <div className="flex items-center gap-4">
                ...
                >
                  ...
                  <span className="hidden sm:inline">{user.role === 'ADMIN' ? t('header.admin') : t('header.dashboard')}</span>
                </button>
                <button
